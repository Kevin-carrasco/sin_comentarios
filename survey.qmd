...
survey-settings:
  ...
  # Every question is listed here explicitly (instead of all-questions-required:
  # true) so we can deliberately exclude two questions:
  #   - attention_check: designed to be left blank on purpose (attention trap);
  #     making it required would force an answer and break the check.
  #   - ranking_politicas: a matrix question with its own custom "at least 3
  #     of 5 rows" enforcement (see app.R); adding it here would instead force
  #     all 5 rows, overriding that intentional partial-completion rule.
  required-questions:
    - consent_understand
    - respondent
    - sexo
...
Esta es la encuesta del proyecto FONDECYT "Justicia de Mercado y Merecimiento del Bienestar Social - [JUSMER](https://jus-mer.com/)". Su objetivo es entender mejor las opiniones de las personas sobre la justicia y el merecimiento en el contexto de la desigualdad social.

Estamos pre-testeando una sección de la encuesta y nos gustaría mucho que pudiera responderla y nos hiciera comentarios, no debería tomar más de 10 minutos. Sus respuestas serán completamente anónimas y se utilizarán únicamente con fines de investigación.
...
# Módulo Tarea de asignación de becas

A continuación, pasaremos a una sección diferente. Le presentaremos una serie de situaciones en las que le pediremos que evalúe información sobre dos postulantes y tome una decisión de asignación de recursos entre ellos.
...
- Imagine que Ud. forma parte de un **comité universitario encargado de asignar una beca** de apoyo a estudiantes de primer año. 
- Los postulantes serán presentados de a pares, con información sobre cada uno proporcionada por el colegio del que egresaron.
- Ambos postulantes fueron aceptados en la misma carrera y universidad, y en esta carrera los estudiantes deben pagar para estudiar (no hay acceso a gratuidad).
- El monto disponible es de **$2.000.000** para el primer año.
:::

::: {.callout-tip}
## Su tarea:

- En cada par, Ud. debe repartir la beca asignando a cada postulante un porcentaje del monto total de la beca ($ 2.000.000), considerando las características de cada uno que se presentarán en una tabla. 
- Dado que el monto disponible para distribuir entre cada par es fijo, otorgar más dinero a un postulante implica otorgar menos al otro.  

**No hay respuestas correctas ni incorrectas; solo nos interesa su opinión.**
:::
...
<center>
# Módulo Actitudes hacia la desigualdad
</center>
...
<center>
# Módulo Percepción de servicios públicos y privados
</center>
